        ...
        <div class="page-content">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        <a href="index" style="color: #5a6667 !important;">Escritório</a> / Segurança
                    </div>
                </div>
            </div>
            <form method="POST">
                <div class="col-md-12  text-center">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <input type="password" class="form-control" name="newpass" placeholder="Nova Senha" size="10" style="text-align: center; color:black" required="">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
