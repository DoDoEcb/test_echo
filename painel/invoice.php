        ...
        <div class="page-content">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12">
                        <a href="index" style="color: #5a6667 !important;">Escritório</a> / Pedidos
                    </div>
                </div>
            </div>
                        ...
                        ?>
                            ...
                            <script type="text/javascript">
                                function request<?php echo $ref->pedido;?>() {
                                    ...
                                    document.getElementById('wallet').innerHTML = "<?php echo $Wallet->data->address?>;";
                        ...
                        <form method="post">
                            <form method="post">
                                <center> <div class="modal-body">
                                        ...
                                        <center><img src='https://chart.googleapis.com/chart?cht=qr&chl=bitcoin%3A<?php echo'<b id="wallet"></b>'?>%3Famount%3D<?php echo $price?>&chs=180x180&choe=UTF-8&chld=L|2' rel='nofollow' alt='qr code'><a href='http://www.qrcode-generator.de' border='0' style='cursor:default'  rel='nofollow'></a></center>
